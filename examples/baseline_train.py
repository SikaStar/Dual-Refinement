...
from reid.trainers import ClusterBaseTrainer
...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        # Trainer
        trainer = ClusterBaseTrainer(model, args.num_clusters, args.lmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rho', default=1.6e-3, type=float,
                        help='parameter for DBSCAN')
